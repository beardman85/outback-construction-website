 ...
 * Community names are reverse-geocoded from the GPS, then confirmed by the owner:
 * Beaver Lake, Lake Ernst (Duncan), the two Platte River beach sites near Fremont,
 * and the two Omaha-metro pins (seawall / beach reclamation) are all owner-verified.
 *
 * TODO[MATT]: North Bend is still marked 'general' — what service was that job?
 */
...
export const jobs: Job[] = [
  ...
  { id: '02', lat: 41.3955, lng: -96.49114, service: 'beach-reclamation', community: 'Woodcliff', title: 'Sand beach & shoreline' },
  { id: '03', lat: 41.42262, lng: -96.53194, service: 'beach-reclamation', community: 'Platte River · Fremont area', title: 'Platte River beach' },
  ...
  { id: '10', lat: 41.34336, lng: -97.44261, service: 'seawalls', community: 'Lake Ernst · Duncan', title: 'Seawall & beach — large shoreline build' },
  ...
  { id: '15', lat: 41.2533, lng: -96.26723, service: 'seawalls', community: 'Omaha metro', title: 'Seawall & sand beach' },
  { id: '16', lat: 41.26723, lng: -96.3289, service: 'beach-reclamation', community: 'Omaha metro', title: 'Beach reclamation' },
];
